...
export const EVENT = {
  ...
  // TODO: trocar por um e-mail que receba mensagens. Também é o reply-to do
  // e-mail de acesso: o domínio navaregistrodeimoveis.com.br não tem MX, então
  // uma resposta ao remetente (EMAIL_FROM) volta com erro.
